...
Route::controller(EmployeeController::class)->group(function () {
    Route::get('/employess', 'showEmployees')->name('employees.index')->middleware('isAuthenticated:employee'); // Accept multiple roles
    Route::get('/admin-employess', 'AdminEmployees')->name('employees.admin')->middleware('isAuthenticated:admin'); // Accept multiple roles
    Route::get('/show/{id}', 'showEmployee')->name('employees.show')->middleware('isAuthenticated:admin');
